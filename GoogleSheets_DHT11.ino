...
String Sheets_GAS_ID = "AKfycbyC15PVWUxmBVEitmKDbB9FH7Ro3c9_gR-POOGhunEj1dYN_3xE-mazMr27uqsNhHUb";                                         /*This is the Sheets GAS ID, you need to look for your sheets id*/
...
void setup() 
{
  ...
  WIFI_Connect("ASUS","ASUS123456");                                                     /*Provide you Wi-Fi SSID and password to connect to Wi-Fi*/
