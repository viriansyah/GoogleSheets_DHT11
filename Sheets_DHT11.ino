...
String Sheets_GAS_ID = "AKfycbzablCr0wz_ExEgisB5ACpAZ0VFpg-tBRV4mMMnnQ4ii12w5sRGxp2KaHjmYfDprYk";                                         /*This is the Sheets GAS ID, you need to look for your sheets id*/
...
void setup() 
{
  ...
  WIFI_Connect("SIVIE-HP","dimcan@1974");                                                     /*Provide you Wi-Fi SSID and password to connect to Wi-Fi*/
